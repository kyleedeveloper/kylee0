...
const embed = new EmbedBuilder()
.setTitle("Kylee - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('Kylee - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("Kylee - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("Kylee - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Kylee - Kullanıcı Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    if (interaction.values[0] == "giveaway") {
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Kylee - Çekiliş Sistemi!")
